...
- **The pack manifest** (this repo: `pack.toml`, `index.toml`, the 128 `mods/*.pw.toml` files, scripts and docs) is covered by [LICENSE](LICENSE) — feel free to fork, study, learn from it.
